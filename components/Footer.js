  ...
  return (
    <footer className="footer">
      <div className="container footer-container">
        <div className="footer-section">
          ...
          <p>
            ...
            connections within the Muslim community. Our platform is designed to
            empower individuals to discover mosques, connect with fellow
      ...
      <div className="copyright container">
        <p>Copyright 2025 MosqueZawaj.Co. All Rights are reserved</p>
        <div className="terms">
